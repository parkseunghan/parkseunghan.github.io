---
title: "KnockOn Bootcamp 2nd - 3.6 SQLi WAF 6"
categories:
  - Web Hacking
tags:
  - Wargame
  ...
  - Filter Bypass
last_modified_at: 2024-08-30T07:30:00+09:00
published: true
---
## 문제
...
![3.6 SQLi WAF 6 1](/assets/images/writeup/web-hacking/knock-on/knock-on-challenge-3-6-sqli-waf-6-1.png)

![3.6 SQLi WAF 6 2](/assets/images/writeup/web-hacking/knock-on/knock-on-challenge-3-6-sqli-waf-6-1.png)

![3.6 SQLi WAF 6 3](/assets/images/writeup/web-hacking/knock-on/knock-on-challenge-3-6-sqli-waf-6-1.png)
...
union의 최종 결과의 열 이름은 첫 번째 쿼리의 열 이름을 사용하기 때문이다. `AS`를 이용해 컬럼 명을 바꾸어 사용하기 위해서는 쿼리 순서가 반드시 지켜져야 함
